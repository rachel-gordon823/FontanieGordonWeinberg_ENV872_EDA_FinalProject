...
PM10_heatmap <- ggplot(Full_air_quality_21_22, aes(x = City_Year, y = pm10, fill = pm10))+
geom_tile() +
  scale_fill_gradient2(
  low = "#66FF00",
  mid = "#FFFF33",
...
PM25_dotplot <- ggplot(Full_air_quality_21_22, 
  ...
  labs(x = "City Year", y = "PM2.5", color = "City Year")+
...
```{r Plotting.PM25, fig.cap = "Comparing PM2.5 in Dnipro and Lviv, Ukraine", echo = FALSE} 
# DNIPRO PM2.5
