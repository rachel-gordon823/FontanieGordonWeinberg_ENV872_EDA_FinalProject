...
\FunctionTok{write.csv}\NormalTok{(Ukraine\_Processed, }\AttributeTok{row.names =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{file =} \StringTok{"./Data/Processed/Ukraine\_Processed.csv"}\NormalTok{)}

\CommentTok{\# Creating subsets by city, month, and year}
...
\FunctionTok{write.csv}\NormalTok{(Dnipro\_2021, }\AttributeTok{row.names =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{file =} \StringTok{"./Data/Processed/Dnipro\_2021.csv"}\NormalTok{)}
